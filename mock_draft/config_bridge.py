...
MAX_POSITION_SATURATION_ADJUSTMENT = _cfg.MAX_POSITION_SATURATION_ADJUSTMENT
# Roster-shape inputs for the positional-saturation term.
FLEX_SHARE = _cfg.FLEX_SHARE
BENCH_DEMAND_PER_TEAM = _cfg.BENCH_DEMAND_PER_TEAM
