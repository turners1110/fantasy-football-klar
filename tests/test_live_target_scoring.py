...
def test_weak_te_does_not_outrank_strong_cheap_player_when_replacement_te_exists():
    weak_te = compute_target_score(
        player="Weak TE", position="TE", marginal_value=60.0, expected_role="required starter",
        live_expected_price=20.0, exact_or_approx_ceiling=22.0, hard_max=20.0,
    ...
    strong_wr = compute_target_score(
        player="Strong WR", position="WR", marginal_value=150.0, expected_role="FLEX starter",
        live_expected_price=30.0, exact_or_approx_ceiling=70.0, hard_max=65.0,
        remaining_alternatives_count=3, is_last_legal_alternative=False,
...
def test_final_viable_te_value_rises_when_no_alternative_remains():
    with_alt = compute_target_score(
        player="Last TE", position="TE", marginal_value=90.0, expected_role="required starter",
        live_expected_price=15.0, exact_or_approx_ceiling=25.0, hard_max=22.0,
...
def test_cheaper_of_two_equal_gain_players_ranks_higher():
    common = dict(marginal_value=100.0, expected_role="FLEX starter", exact_or_approx_ceiling=60.0,
    ...
    cheap = compute_target_score(player="Cheap", position="WR", live_expected_price=20.0, **common)
    expensive = compute_target_score(player="Expensive", position="WR", live_expected_price=45.0, **common)
...
def test_qb_falls_sharply_to_bench_after_allen_reflected_in_score():
    before_allen = compute_target_score(
        player="Backup QB", position="QB", marginal_value=180.0, expected_role="required starter",
        live_expected_price=15.0, exact_or_approx_ceiling=30.0, hard_max=28.0,
    ...
    after_allen = compute_target_score(
        player="Backup QB", position="QB", marginal_value=27.0, expected_role="bench depth",
        live_expected_price=15.0, exact_or_approx_ceiling=30.0, hard_max=28.0,
        remaining_alternatives_count=4, is_last_legal_alternative=False,
...
def test_strong_rb_after_five_rbs_gets_bench_depth_treatment():
    score = compute_target_score(
        player="Strong RB", position="RB", marginal_value=10.0, expected_role="bench depth",
        live_expected_price=40.0, exact_or_approx_ceiling=50.0, hard_max=45.0,
...
def test_wr_displacing_weakest_flex_gets_starting_lineup_gain_credit():
    score = compute_target_score(
        player="Flex WR", position="WR", marginal_value=45.0, expected_role="FLEX starter",
        live_expected_price=20.0, exact_or_approx_ceiling=35.0, hard_max=32.0,
        remaining_alternatives_count=2, is_last_legal_alternative=False,
...
def test_position_need_never_exceeds_its_capped_share_of_total():
    ...
    score = compute_target_score(
        player="X", position="TE", marginal_value=5.0, expected_role="required starter",
        live_expected_price=50.0, exact_or_approx_ceiling=10.0, hard_max=5.0,
        remaining_alternatives_count=3, is_last_legal_alternative=False,
...
def test_all_recommendation_classes_from_allowed_set():
    score = compute_target_score(
        player="X", position="WR", marginal_value=50.0, expected_role="FLEX starter",
        live_expected_price=20.0, exact_or_approx_ceiling=40.0, hard_max=36.0,
        remaining_alternatives_count=3, is_last_legal_alternative=False,
...
def test_pass_above_limit_when_price_exceeds_hard_max():
    score = compute_target_score(
        player="X", position="WR", marginal_value=50.0, expected_role="FLEX starter",
        live_expected_price=60.0, exact_or_approx_ceiling=40.0, hard_max=36.0,
        remaining_alternatives_count=3, is_last_legal_alternative=False,
        price_confidence=0.6, position_need_score=0.3, portfolio_paths_broken_if_missed=0,
    )
